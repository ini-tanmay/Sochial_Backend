...
from api.snippet.snippetsbypostid import SnippetsByPostID
...
restServerInstance.add_resource(SnippetsByPostID, "/api/v1.0/<string:postID>/<string:type>/snippets", endpoint='get_snippets_by_post_id')
